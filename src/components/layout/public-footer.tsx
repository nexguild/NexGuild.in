...
export function PublicFooter() {
  return (
    <footer 
      className="bg-[#FAF6EF] border-t border-stone-200"
    >
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.borderColor = "rgba(146, 64, 14, 0.35)";
                  e.currentTarget.style.background = "rgba(146, 64, 14, 0.05)";
                }}
                onMouseLeave={(e) => {
          ...
          {/* Platform */}
          <div>
            <h4 className="text-xs font-semibold mb-4 uppercase tracking-wider text-stone-900">
              Platform
            </h4>
            <ul className="space-y-3">
              {PLATFORM_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm transition-colors text-stone-600 hover:text-amber-800"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm transition-colors text-stone-600 hover:text-green-600"
                >
                  WhatsApp
                </a>
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm transition-colors text-stone-600 hover:text-sky-600"
                >
                  Telegram
                </a>
              </li>
        ...
        <div 
          className="mt-10 pt-6 border-t border-stone-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3"
        >
