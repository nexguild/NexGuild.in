  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 right-5 lg:bottom-24 lg:right-6 z-50 h-14 w-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200 bg-[#f59e0b]"
      >
