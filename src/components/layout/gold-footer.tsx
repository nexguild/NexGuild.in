...
export function GoldFooter() {
  ...
  rel="noopener noreferrer"
  aria-label="X"
  className="h-8 w-8 rounded-md flex items-center justify-center border border-white/10 text-stone-500 hover:text-white hover:border-white/40 transition-colors"
>
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
