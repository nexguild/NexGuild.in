...
>
  ...
  You Get the Data.
      ...
      {/* ── What we do (Glossy Content Section) ─────────────────────────── */}
      ...
      {/* ── Pillars (Premium Grid Cards with Pop-up Animation) ───────────── */}
          ...
          <FadeIn>
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {/* Contact Us Button - Premium Amber/Gold */}
                <Link
                  href="/contact"
                  style={{
                    display: "inline-flex",
                ...
                {/* View Services Button - Transparent Border Premium */}
                <Link
                  href="/services"
                  style={{
                    display: "inline-flex",
