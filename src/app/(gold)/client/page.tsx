...
const SERVICES = [
  ...
  { icon: "✋", name: "Palm & Face Data",      desc: "Biometric training datasets with consent forms" },
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {STATS.map((s, i) => (
              <FadeIn key={s.label} delay={i * 60} className="h-full">
                <div
                  className="flex flex-col items-center justify-center text-center p-6 rounded-2xl h-full transition-all duration-300 hover:translate-y-[-4px] hover:bg-white hover:shadow-md"
                  style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((step, i) => (
              <FadeIn key={step.n} delay={i * 80} className="h-full">
                <div
                  className="flex flex-col items-center text-center p-6 rounded-2xl h-full transition-all duration-300 hover:translate-y-[-4px] hover:bg-white hover:shadow-md"
                  style={{
                    background: "rgba(255,255,255,0.5)",
                    border: "1.5px solid rgba(217,119,6,0.12)",
                  }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHY.map((item, i) => (
              <FadeIn key={item.title} delay={i * 60} className="h-full">
                <div
                  className="rounded-xl p-5 h-full transition-all duration-300 hover:translate-y-[-4px] hover:bg-white hover:shadow-md"
                  style={{
                    background: "rgba(255,255,255,0.5)",
                    border: "1.5px solid rgba(217,119,6,0.12)",
                  }}
