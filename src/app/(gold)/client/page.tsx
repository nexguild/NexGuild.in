    ...
    <div style={{ background: "#FAF6EF", color: "#1C1917", minHeight: "100vh" }}>
        ...
        <div className="relative z-10 mx-auto max-w-container px-6 pt-28 pb-10 text-center">
          ...
          <FadeIn delay={200}>
            ...
            >
              ...
              <br />You define the work. We handle the rest.
            </p>
          </FadeIn>
      ...
      <FadeIn>
        <section style={{ padding: "0 1.5rem" }}>
          ...
          >
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-0 sm:divide-x" style={{ borderColor: "rgba(217,119,6,0.15)" }}>
              {STATS.map((s) => (
                <div key={s.label} className="flex flex-col items-center text-center sm:px-8 py-8">
                  <span style={{ color: "#92400E", fontSize: "1.875rem", fontWeight: 800, lineHeight: 1, marginBottom: "0.25rem" }}>
                    {s.value}
                  </span>
                  <span style={{ color: "#44403C", fontSize: "0.875rem" }}>{s.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHY.map((w, i) => (
              <FadeIn key={w.title} delay={i * 60}>
                ...
                >
                  <span style={{ fontSize: "1.5rem", lineHeight: 1.1 }}>{w.icon}</span>
                  <div>
                    <h3 style={{ color: "#1C1917", fontWeight: 700, marginBottom: "0.4rem" }}>{w.title}</h3>
                    <p style={{ color: "#44403C", fontSize: "0.95rem", lineHeight: 1.7 }}>{w.desc}</p>
                  </div>
                </div>
              </FadeIn>
            ))}
