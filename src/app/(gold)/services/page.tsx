...
>
  Get a Quote <ArrowRight className="h-4 w-4" />
      ...
      {/* ── How Engagement Works Segment (Premium Pop-up Cards) ─────────────────── */}
<section style={{ background: "rgba(255,255,255,0.3)", backdropFilter: "blur(12px)", padding: "4rem 1.5rem", borderTop: "1px solid rgba(217,119,6,0.06)", borderBottom: "1px solid rgba(217,119,6,0.06)" }}>
  <div className="mx-auto max-w-container">
    ...
    {/* ── CTA Segment (Color Coded & Upgraded Buttons) ─────────────────────────────────── */}
<section style={{ background: "#FAF6EF", padding: "4rem 1.5rem" }}>
  <div className="mx-auto max-w-container">
    <FadeIn>
      <div 
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          {/* ১. WhatsApp Button (Official Brand Green with Soft Shadow) */}
          <a 
          ...
          {/* ২. Send Email (NexGuild Signature Premium Amber/Gold) */}
          <Link 
            href="/contact"
            style={{
              display: "inline-flex",
